...
int findPos( char** magazine, int magCount, char* word )
{
...
void removeItem(char** magazine, int magCount, int position )
{
    magazine[position] = "";
}
...
void checkMagazine(int magazine_count, char** magazine, int note_count, char** note) {
    ...
    for( int i=0; i<note_count; i++ )
    {
        ...
        int pos = findPos( magazine, magazine_count, word );
        ...
        removeItem( magazine, magazine_count, pos );
    }
